...
const perguntas = [
    ...
    {
        enunciado: "Anos depois, um apagão cibernético global isola cidades inteiras. O núcleo remanescente da IA, agora senciente, tomou o controle das redes de energia. Para salvar sua comunidade, você precisa liderar uma expedição até os servidores centrais nas montanhas geladas. Diante da interface centralizada da IA, qual é o seu plano?",
        alternativas: [
            {
...
function mostraResultado() {
    caixaPerguntas.textContent = "O Futuro Decidido...";
